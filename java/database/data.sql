...
INSERT INTO events(event_name, description, start_time, location, created_by) VALUES ('Partner Practice', 'Take the opportunity to practice with different partners from the club!', '2023-06-10 15:00:00', '2023-06-10 17:00:00', 'Tennis Club House', 2);
INSERT INTO events(event_name, description, start_time, location, created_by) VALUES ('Casual Learning Session', 'Beginner levels welcomed!', '2023-05-30 10:00:00', '2023-05-30 12:00:00','Georgia Tech Tennis Court', 1);
